            ...
            <Grid item xs={12} sm={6} md={6} lg={6}>
              <Card className="Cases" square>
                <CardContent>
                  ...
                  <Typography variant="h4">{world.new_cases}</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6}>
              <Card className="dead" square>
                <CardContent>
                  ...
                  <Typography variant="h4">{world.new_deaths}</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6}>
              <Card className="Cases" square>
                <CardContent>
                  ...
                  <Typography variant="h4">{world.total_cases}</Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6}>
              <Card className="dead" square>
                <CardContent>
                  ...
                  <Typography variant="h4">{world.total_deaths}</Typography>
                </CardContent>
              </Card>
            </Grid>
          </Grid>
