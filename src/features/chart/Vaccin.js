...
import {AreaChart,ResponsiveContainer,XAxis,YAxis,Area,Tooltip,CartesianGrid } from 'recharts';
              ...
              <Grid item xs={12}  md={4} lg={4} >
                    <Card square>
                        <CardContent>
                          ...
                          <Typography variant="h3" component="h2" className='recover'>
                            {vaccin.first.total}
                          </Typography>
                        </CardContent>
                    </Card>
                      ...
                      <Paper elevation={4}>
                          ...
                          <ResponsiveContainer width='100%' height={400}>
                              <AreaChart data={vaccin.first.datas}>
                                  ...
                                  <YAxis dataKey='z'  tickFormatter={number => formatNumber(number)}/>
